-- Plugin to render markdown files directly in neovim
  ...
  config = function()
    require('render-markdown').setup({
      ...
      callout = {
        ...
        invalid = { raw = '[!INVALID]', rendered = '󰳦 Invalid', highlight = 'RenderMarkdownError' },
        ...
        question = { raw = '[!QUESTION]', rendered = '󰘥 Question', highlight = 'RenderMarkdownInfo' },
        help = { raw = '[!HELP]', rendered = '󰘥 Help', highlight = 'RenderMarkdownInfo' },
        faq = { raw = '[!FAQ]', rendered = '󰘥 Faq', highlight = 'RenderMarkdownInfo' },
        attention = { raw = '[!ATTENTION]', rendered = '󰀪 Attention', highlight = 'RenderMarkdownWarn' },
        failure = { raw = '[!FAILURE]', rendered = '󰅖 Failure', highlight = 'RenderMarkdownError' },
        fail = { raw = '[!FAIL]', rendered = '󰅖 Fail', highlight = 'RenderMarkdownError' },
        fixme = { raw = '[!FIXME]', rendered = '󰅖 Fix Me', highlight = 'RenderMarkdownError' },
