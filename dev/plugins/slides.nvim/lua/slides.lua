...
local defaults = {
  executors = {
    ...
    shell = M.create_system_executor("shell"),
...
---@field syntax slides.SyntaxOptions: The syntax for the plugin

---@class slides.SyntaxOptions
...
---@class slides.Slides
---@field slides slides.Slide[]: The slides of the file

---@class slides.Slide
---@field title string: The title of the slide
---@field body string[]: The body of slide
---@field blocks slides.Block[]: A codeblock inside of a slide
...
local slides_keymap = function(mode, key, callback)
...
M.start_presentation = function(opts)
  ...
  slides_keymap("n", "j", function()
    state.current_slide = math.min(state.current_slide + 1, #state.parsed.slides)
    set_slide_content(state.current_slide)
  end)

  slides_keymap("n", "k", function()
  ...
  vim.api.nvim_create_autocmd("VimResized", {
    group = vim.api.nvim_create_augroup("initial-resized", {}),
    callback = function()
